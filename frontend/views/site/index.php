  ...
  <div id="rev_slider_24_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="website-intro" data-source="gallery" style="background:#000000;padding:0px;">
    ...
    <div id="rev_slider_24_1" class="rev_slider fullscreenbanner tiny_bullet_slider" style="display:none;" data-version="5.4.1">
      <ul class="js-scroll-nav">
        <!-- SLIDE  -->
        <li data-index="rs-67" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="./img-temp/1920x1080/img24.jpg" data-rotate="0"
          ...
          <!-- MAIN IMAGE -->
          <img src="./img/bg/11.jpg" alt="" data-bgposition="center center" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="20"
          ...
          <div class="tp-caption   tp-resizeme" id="slide-67-layer-2" data-x="['center','center','center','center']" data-hoffset="['1','1','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-70','-70','-70','-70']" data-fontsize="['90','90','70','50']"
               ...
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 700; color: #ffffff; letter-spacing: -5px;">Soporte Técnico
          </div>
          ...
          <div class="tp-caption   tp-resizeme" id="slide-67-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['90','90','60','30']" data-fontsize="['25','25','25','20']"
               ...
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;">Brindamos soporte técnico tanto a nivel empresarial como a nivel particular.
          </div>

          <!-- LAYER NR. 17 -->
          <a class="tp-caption rev-btn g-bg-primary tp-resizeme" href="#it" id="slide-67-layer-7" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
             ...
             data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[50,50,50,50]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[50,50,50,50]" style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;text-transform: uppercase;">Ver Mas </a>
        </li>
        <!-- SLIDE  -->
        <li data-index="rs-66" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="./img-temp/1920x1080/img9.jpg" data-rotate="0"
            data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
          <!-- MAIN IMAGE -->
          <img src="./img/bg/12.jpg" alt="" data-bgposition="center top" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="20"
               data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg">
          <!-- LAYERS -->
          ...
          <div class="tp-caption   tp-resizeme" id="slide-66-layer-2" data-x="['center','center','center','center']" data-hoffset="['1','1','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-70','-70','-70','-70']" data-fontsize="['90','90','70','50']"
               data-lineheight="['90','90','70','50']" data-width="['none','none','481','360']" data-height="none" data-whitespace="['nowrap','nowrap','normal','normal']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 700; color: #ffffff; letter-spacing: -5px;">Desarrollo Web
          </div>
          ...
          <div class="tp-caption   tp-resizeme" id="slide-66-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['90','90','60','30']" data-fontsize="['25','25','25','20']"
               data-lineheight="['35','35','35','30']" data-width="['480','480','480','360']" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;">Desarrollamos tu sitio web a la medida de tu negocio.
          </div>

          <!-- LAYER NR. 34 -->
          <a class="tp-caption rev-btn  g-bg-primary tp-resizeme" href="#development" id="slide-66-layer-7" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']"
             data-voffset="['200','200','160','120']" data-width="250" data-height="none" data-whitespace="nowrap" data-type="button" data-actions='' data-responsive_offset="on" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"0","ease":"Linear.easeNone","to":"o:1;rX:0;rY:0;rZ:0;z:0;fb:0;","style":"c:rgba(255,255,255,1);bs:solid;bw:0 0 0 0;"}]'
             data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[50,50,50,50]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[50,50,50,50]" style="z-index: 21; min-width: 250px; max-width: 250px; white-space: nowrap; font-size: 18px; line-height: 60px; font-weight: 700; color: rgba(255,255,255,1); border-color:rgba(0,0,0,1);border-radius:30px 30px 30px 30px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;text-transform: uppercase;">Ver Mas </a>
        </li>
        <!-- SLIDE  -->
        <li data-index="rs-68" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="600" data-thumb="./img-temp/1920x1080/img1.jpg" data-rotate="0"
            data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="" data-slicey_shadow="0px 0px 0px 0px transparent">
          <!-- MAIN IMAGE -->
          <img src="./img/bg/03.jpg" alt="" data-bgposition="center top" data-kenburns="on" data-duration="5000" data-ease="Power2.easeInOut" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="20"
               data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg">
          <!-- LAYERS -->
          ...
          <div class="tp-caption   tp-resizeme" id="slide-68-layer-2" data-x="['center','center','center','center']" data-hoffset="['1','1','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-70','-70','-70','-70']" data-fontsize="['90','90','70','50']"
               data-lineheight="['90','90','70','50']" data-width="['none','none','481','360']" data-height="none" data-whitespace="['nowrap','nowrap','normal','normal']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 19; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 700; color: #ffffff; letter-spacing: -5px;">Somos Geknology
          </div>
          ...
          <div class="tp-caption   tp-resizeme" id="slide-68-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['90','90','60','30']" data-fontsize="['25','25','25','20']"
               data-lineheight="['35','35','35','30']" data-width="['480','480','480','360']" data-height="none" data-whitespace="normal" data-type="text" data-responsive_offset="on" data-frames='[{"delay":1000,"speed":2000,"frame":"0","from":"sX:0.9;sY:0.9;opacity:0;fb:20px;","to":"o:1;fb:0;","ease":"Power3.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"sX:0.9;sY:0.9;opacity:0;fb:20px;","ease":"Power3.easeInOut"}]'
               data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 20; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff; letter-spacing: 0px;">Soluciones tecnológicas a tu alcance.
          </div>

          <!-- LAYER NR. 51 -->
          <a class="tp-caption rev-btn g-bg-primary tp-resizeme" href="#about" id="slide-68-layer-7"
...
<!-- About Us -->
<section id="about" class="container g-pt-80 g-pb-40">

  <div class="container text-center g-mb-60">
    <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
      <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-color-primary g-mb-20">Quienes Somos</h4>
      <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">Somos Geknology</h2>
    </div>

    <p class="lead g-color-black-opacity-0_8 mb-0">Geknology es una empresa dedicada a la integración tecnológica con visión a futuro, desarrollando soluciones con procedimientos y estándares de calidad.</p>
  </div>

  <div class="row">
    <div class="col-lg-6 g-mb-50">
      <img class="img-fluid" src="./img/inline/img1.png" alt="Image Description">
    </div>
    <div class="col-lg-6">
      <div class="mb-5">
        <p class="g-mb-30">En Geknology comprendemos la importancia de la tecnología para el desarrollo y evolución de una empresa, por eso ofrecemos múltiples servicios a la medida de cada persona o negocio.</p>
        <div class="row">
          <div class="col-sm-6">
...
<div class="container g-pb-40">
  <div id="carouselCus1" class="js-carousel" data-infinite="true" data-autoplay="true" data-slides-show="6">
    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/unique.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/remesas.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/lindaprimavera.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/sclconsulting.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/sushistosos.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/cosmopolitan.png" alt="Image Description">
    </div>

    <div class="js-slide u-block-hover">
      <img class="mx-auto g-width-80 u-block-hover__main--grayscale g-opacity-0_3 g-opacity-1--hover g-cursor-pointer" src="./img/clients/perseverancia.png" alt="Image Description">
    </div>
...
<section id="it1" class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-pos-rel g-overflow-hidden" data-options='{direction: "reverse", settings_mode_oneelement_max_offset: "150"}'>
  ...
  <div class="container g-z-index-1 g-pt-80 g-pb-40">
    <div class="container text-center g-color-gray-light-v5 g-mb-60">
      <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
        <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20">Soporte Técnico</h4>
        <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">Soporte Técnico Empresarial</h2>
      </div>
      <p class="lead g-color-gray-light-v5 mb-0">Ofrecemos una amplia gama de servicios de soporte para esos inconvenientes que puedan conllevar a una baja productividad o elevación de costos en su empresa, tan práctico como tener tu propio departamento de soporte.</p>
    </div>
      ...
      <div class="shortcode-html">
        <div class="row">
          <div class="col-md-4 g-mb-30">
            <!-- Article -->
            <article class="text-center g-bg-white g-rounded-15 g-overflow-hidden g-transform-scale-0_9 g-transform-scale-1--hover g-transition-0_3">
              <!-- Article Header -->
              <header class="g-bg-primary g-pos-rel g-px-20 g-py-50">
                ...
                <strong class="d-block g-color-white g-font-size-50 g-line-height-0_7 g-mb-20">
                  ...
                  6.900
                  <br /><span class="g-font-size-default">mensual por equipo</span>
                </strong>
                <h3 class="h6 text-uppercase g-color-white-opacity-0_7 g-letter-spacing-3 g-mb-20">Plan Básico</h3>
              </header>
              <!-- End Article Header -->

              <!-- Article Content -->
              <div class="js-scroll-nav g-px-20 g-py-20">
                <ul class="list-unstyled g-mb-40">
                  <li class="g-mb-15 g-font-size-16">1 visita mensual</li>
                  <li class="g-mb-15 g-font-size-16"><del>1 visita de emergencia</del></li>
                  <li class="g-mb-15 g-font-size-16">Mantención preventiva</li>
                  <li class="g-mb-15 g-font-size-16">5% dcto. en otros servicios</li>
                  <li class="g-mb-15 g-font-size-16">Soporte teléfonico</li>
                  <li class="g-mb-15 g-font-size-16"><del>Soporte remoto</del></li>
                  <li class="g-mb-15 g-font-size-16"><del>Limpieza interna</del></li>
                  <li class="g-mb-15 g-font-size-16">Informe de resultados</li>
                </ul>
                <a class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10" href="#contact">Contratar</a>
              </div>
              <!-- End Article Content -->
            </article>
            <!-- End Article -->
          ...
          <div class="col-md-4 g-mb-30">
            <!-- Article -->
            <article class="text-center g-bg-white g-rounded-15 g-overflow-hidden g-transform-scale-1 g-transform-scale-1_1--hover g-transition-0_3">
              <!-- Article Header -->
              <header class="g-bg-primary g-pos-rel g-px-20 g-py-50">
                <svg class="g-pos-abs g-bottom-0 g-left-0 g-right-0" version="1.1" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="70px" viewBox="0 0 300 70">
                  <path d="M30.913,43.944c0,0,42.911-34.464,87.51-14.191c77.31,35.14,113.304-1.952,146.638-4.729 c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z" opacity="0.6" fill="#ffffff" />
                ...
                <h3 class="h6 text-uppercase g-color-white-opacity-0_7 g-letter-spacing-3 g-mb-20">Plan Intermedio</h3>
              </header>
              <!-- End Article Header -->
              ...
              <div class="js-scroll-nav g-px-20 g-py-20">
                <ul class="list-unstyled g-mb-40">
                  <li class="g-mb-15 g-font-size-16">1 visita mensual</li>
                  <li class="g-mb-15 g-font-size-16">1 visita de emergencia</li>
                  <li class="g-mb-15 g-font-size-16">Mantención preventiva</li>
                  <li class="g-mb-15 g-font-size-16">15% dcto. en otros servicios</li>
                  <li class="g-mb-15 g-font-size-16">Soporte teléfonico</li>
                  <li class="g-mb-15 g-font-size-16">Soporte remoto</li>
                  <li class="g-mb-15 g-font-size-16"><del>Limpieza interna</del></li>
                  <li class="g-mb-15 g-font-size-16">Informe de resultados</li>
                </ul>
                <a class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10" href="#contact">Contratar</a>
          ...
          <div class="col-md-4 g-mb-30">
            ...
            <article class="text-center g-bg-white g-rounded-15 g-overflow-hidden g-transform-scale-0_9 g-transform-scale-1--hover g-transition-0_3">
              ...
              <header class="g-bg-primary g-pos-rel g-px-20 g-py-50">
                ...
                <h3 class="h6 text-uppercase g-color-white-opacity-0_7 g-letter-spacing-3 g-mb-20">Plan Premium</h3>
              </header>
              <!-- End Article Header -->
              ...
              <div class="js-scroll-nav g-px-20 g-py-20">
                <ul class="list-unstyled g-mb-40">
                  ...
                  <li class="g-mb-15 g-font-size-16">1 visita de emergencia</li>
                  <li class="g-mb-15 g-font-size-16">Mantención preventiva</li>
                  <li class="g-mb-15 g-font-size-16">20% dcto. en otros servicios</li>
                  <li class="g-mb-15 g-font-size-16">Soporte teléfonico</li>
                  <li class="g-mb-15 g-font-size-16">Soporte remoto</li>
                  <li class="g-mb-15 g-font-size-16">Limpieza interna</li>
                  <li class="g-mb-15 g-font-size-16">Informe de resultados</li>
                </ul>
                <a class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10" href="#contact">Contratar</a>
              </div>
...
<section id="it2" class="container g-pt-80 g-pb-40">
  <div class="container text-center g-mb-60">
    <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
      ...
      <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">Soporte Técnico a Domicilio</h2>
    </div>

    <p class="lead g-color-black-opacity-0_8 mb-0">Nos trasladamos a su oficina o domicilio para solucionar cualquier tipo de falla o problema que presente, con la ayuda de nuestros profesionales capacitados y orientados en brindar un trato personalizado, se enfocan en realizar un trabajo de calidad.</p>
  </div>

  <div class="row">
    <div class="col-lg-4 g-mb-30">
      <!-- Article -->
      <article class="u-shadow-v22 g-overflow-hidden g-transform-scale-1_05--hover g-transition-0_3">
        <figure class="g-pos-rel">
          <img class="img-fluid w-100" src="./img/it/01.jpg" alt="Image Description">
        </figure>

        <div class="g-pa-20 g-pb-0 services-container js-scroll-nav">
          <a class="u-link-v5 g-color-primary--hover g-text-underline--none--hover" href="#contact">
            <h3 class="h4 g-font-weight-300 g-mb-0">
              <strong>Mantención lógica</strong>
            </h3>
            <h5 class="h5 g-font-weight-300 g-mb-15">
              (Limpieza a nivel de software/sistema)
            </h5>
          </a>
          ...
          <div class="">
            <ul class="services-list">
              ...
              <li>Verificación de aplicaciones en “inicio automático”.</li>
            </ul>
          </div>
        </div>
        <div class="g-pa-20 services-prices">
          <p class="g-mb-0"><strong>Costo servicio PC ó Notebook: $19.900</strong></p>
          <p class="g-mb-0"><strong>Costo servicio iMac ó Macbook: $29.900</strong></p>
        </div>
        <div class="text-center g-pl-20 g-pr-20 g-pb-20 services-button js-scroll-nav">
          <a href="#contact" class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10"><strong>Solicitar</strong></a>
        </div>
      </article>
      <!-- End Article -->
    </div>
    ...
    <div class="col-lg-4 g-mb-30">
      ...
      <article class="u-shadow-v22 g-overflow-hidden g-transform-scale-1_05--hover g-transition-0_3">
        <figure class="g-pos-rel">
          <img class="img-fluid w-100" src="./img/it/02.jpg" alt="Image Description">
        </figure>

        <div class="g-pa-20 g-pb-0 services-container js-scroll-nav">
            <a class="u-link-v5 g-color-primary--hover g-text-underline--none--hover" href="#contact">
              <h3 class="h4 g-font-weight-300 g-mb-0">
                <strong>Formateo de equipo</strong>
              </h3>
              <h5 class="h5 g-font-weight-300 g-mb-15">
                (Reinstalación de sistema limpio)
              </h5>
            </a>
        ...
        <div class="g-pa-20 services-prices">
          <p class="g-mb-0"><strong>Costo servicio PC ó Notebook: $29.900</strong></p>
          <p class="g-mb-0"><strong>Costo servicio iMac ó Macbook: $39.900</strong></p>
        </div>
        <div class="text-center g-pl-20 g-pr-20 g-pb-20 services-button js-scroll-nav">
          <a href="#contact" class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10"><strong>Solicitar</strong></a>
        </div>
    ...
    <div class="col-lg-4 g-mb-30">
      ...
      <article class="u-shadow-v22 g-overflow-hidden g-transform-scale-1_05--hover g-transition-0_3">
        <figure class="g-pos-rel">
          <img class="img-fluid w-100" src="./img/it/03.jpg" alt="Image Description">
        </figure>

        <div class="g-pa-20 g-pb-0 services-container js-scroll-nav">
          <a class="u-link-v5 g-color-primary--hover g-text-underline--none--hover" href="#contact">
            <h3 class="h4 g-font-weight-300 g-mb-0">
              <strong>Mantención Térmica</strong>
            </h3>
            <h5 class="h5 g-font-weight-300 g-mb-15">
              (Limpieza a nivel de Hardware/físico)
            </h5>
          </a>
          ...
          <div class="">
            <ul class="services-list">
              ...
              <li>Limpieza interna del equipo con alcohol isopropilico.</li>
              <li>Cambio de pasta térmica (sustancia ayuda a disipar el calor interno del equipo).</li>
            </ul>
          </div>
        </div>
        <div class="g-pa-20 services-prices">
          <p class="g-mb-0"><strong>Costo servicio PC: $29.900</strong></p>
          <p class="g-mb-0"><strong>Costo servicio Notebook: $39.900</strong></p>
          <p class="g-mb-0"><strong>Costo servicio iMac ó Macbook:: $48.900</strong></p>
        </div>
        <div class="text-center g-pl-20 g-pr-20 g-pb-20 services-button js-scroll-nav">
          <a href="#contact" class="btn text-uppercase u-btn-primary g-rounded-50 g-font-size-12 g-font-weight-700 g-pa-15-30 g-mb-10"><strong>Solicitar</strong></a>
        </div>
...
<!-- Section -->
<section id="development" class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-pos-rel g-overflow-hidden">
  <div class="divimage dzsparallaxer--target w-100" style="height: 110%; background-image: url(./img/bg/02.jpg);"></div>
  <div class="divimage dzsparallaxer--target w-100" style="height: 110%; background: rgba(0,0,0,0.6);"></div>

    <div class="g-pt-80 g-pb-40">
      <div class="container text-center g-color-gray-light-v5 g-mb-60">
        <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
          <h4 class="h6 g-font-weight-800 g-font-size-12 g-letter-spacing-1 g-mb-20">Desarrollo Web</h4>
          <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">Paso a Paso</h2>
        </div>

        <p class="lead g-color-gray-light-v5 mb-0">En chile, el crecimiento del comercio electrónico es de un 24% anual promedio, independientemente de la crisis. En 2015 el comercio electrónico representó USD$ 25 mil millones, un 4,7% de las ventas totales. Uno de cada dos chilenos tiene internet, el 90% de las personas que tiene acceso a internet declara haber realizado alguna compra.</p>
      </div>

      <div class="container g-mb-20">
        <div class="row">
          <div class="col-lg-6 g-px-30">
            <!-- Icon Blocks -->
            <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
              <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                  <span class="d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(./img/icons/blueprint.png);"></span>
                  <!-- opacity-0--parent-hover -->
                  <span class="u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 g-transition-0_1 g-transition--ease-in">
                    <i class="icon-map"></i>
                  </span>
                </div>
              </div>

              <h3 class="h5 text-uppercase g-color-gray-light-v5 g-mb-10">Paso 1. Análisis</h3>
              <p class="g-color-gray-light-v5 mb-0">Es un proceso de descubrimiento, modelado y especificación, donde se definen las funciones, comportamiento y rendimiento del sitio web.</p>
            </div>
          <!-- End Icon Blocks -->
          </div>
          ...
          <div class="col-lg-6 g-px-30">
            <!-- Icon Blocks -->
            <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-mb-55 g-mt-25 g-px-25 g-pl-70--sm">
              <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                  <span class="d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(./img/icons/windows.png);"></span>
                  <!-- opacity-0--parent-hover -->
                  <span class="u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 g-transition-0_1 g-transition--ease-in">
              ...
              <h3 class="h5 text-uppercase g-color-gray-light-v5 g-mb-10">Paso 2. Diseño</h3>
              <p class="g-color-gray-light-v5 mb-0">Producimos un modelo o representación de una entidad que se va a construir posteriormente. En general, la fase de diseño se refiere la arquitectura del sitio y representaciones de interfaz.</p>
            </div>
            <!-- End Icon Blocks -->
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 g-px-30">
            ...
            <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-py-35 g-px-25 g-pl-70--sm">
              <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
                <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                  <span class="d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(./img/icons/settings.png);"></span>
                  <!-- opacity-0--parent-hover -->
                  <span class="u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 g-transition-0_1 g-transition--ease-in">
            ...
            <h3 class="h5 text-uppercase g-color-gray-light-v5 g-mb-10">Paso 3. Desarrollo</h3>
            <p class="g-color-gray-light-v5 mb-0">Traducimos el diseño a nivel de código, desarrollando la funcionalidad del sitio web con la información obtenida en la fase de análisis y generando al mismo tiempo pruebas prácticas, dirigidas a los módulos o secciones finalizadas.</p>
          </div>
          <!-- End Icon Blocks -->
        </div>
        ...
        <div class="col-lg-6 g-px-30">
          <!-- Icon Blocks -->
          <div class="g-pos-rel g-parent g-theme-bg-blue-dark-v2 g-mb-55 g-mt-45 g-px-25 g-pl-70--sm">
            <div class="g-hidden-xs-down g-absolute-centered--y g-left-0">
              <div class="g-pull-50x-left g-brd-around g-brd-5 g-brd-primary-dark-v3 g-rounded-50x g-overflow-hidden">
                <span class="d-block g-pos-abs g-top-0 g-left-0 g-width-95 g-height-95 g-brd-around g-brd-5 g-brd-primary g-rounded-50x" style="background-image: url(./img/icons/cloud-computing-2.png);"></span>
                  <!-- opacity-0--parent-hover -->
                <span class="u-icon-v3 u-icon-size--xl g-width-95 g-height-95 g-color-white g-bg-primary g-opacity-1 g-transition-0_1 g-transition--ease-in">
            ...
            <h3 class="h5 text-uppercase g-color-gray-light-v5 g-mb-10">Paso 4. Producción</h3>
            <p class="g-color-gray-light-v5 mb-0">Luego de las pruebas realizadas en la fase de desarrollo, preparamos y configuramos el ambiente de producción para implementar el proyecto.</p>
          </div>
          <!-- End Icon Blocks -->
        </div>
      </div>
      ...
      <div class="text-center">
        <a class="btn u-btn-primary g-font-weight-600 g-font-size-13 text-uppercase rounded-3 g-py-12 g-px-35 js-scroll-nav" href="#contact">Solicitar</a>
      </div>
    </div>
  </section>
<!-- End Section -->
  ...
  <div class="">
    <div class="container text-center g-mb-60">
      <div class="text-uppercase u-heading-v2-4--bottom g-brd-primary g-mb-40">
        ...
        <h2 class="h1 u-heading-v2__title g-line-height-1_3 g-font-weight-600 g-font-size-40 g-mb-minus-10">Nuestros Proyectos Recientes</h2>
      </div>
    ...
    <div class="row g-mx-0">
      <div class="col-lg-3 col-md-3 g-mb-0--lg g-px-0">
        <article class="u-block-hover u-shadow-v21 rounded">
          ...
          <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white text-center">
            <h3 class="h4">
                <a class="g-color-white" target="_blank" href="http://www.florerialindaprimavera.cl">Florería Linda Primavera</a>
              </h3>
            <p>Sitio web administrable. Carga, modificación y eliminación de productos para una florería.</p>
          </header>
        </article>
      </div>
      ...
      <div class="col-lg-3 col-md-3 g-mb-0--lg g-px-0">
        <article class="u-block-hover u-shadow-v21 rounded">
          <figure class="u-bg-overlay g-bg-black-opacity-0_6--after">
            <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="./img/portfolio/draestetica.jpg" alt="Image description">
          </figure>

          <header class="u-bg-overlay__inner g-pos-abs g-top-30 g-right-30 g-left-30 g-color-white text-center">
            <h3 class="h4">
                <a class="g-color-white" target="_blank" href="https://www.draestetica.com">Dra. Estética</a>
              </h3>
            <p>Sitio web administrable para una clínica estética.</p>
          </header>
        </article>
      </div>
...
<section id="contact" class="container g-pb-30 g-pt-40">
  <div class="row">
    <div class="col-lg-6 g-mb-50">
      ...
      <p class="g-font-size-18 mb-0">Rellena el formulario con tus datos, envíanos tu solicitud y de inmediato <strong> ¡nos pondremos en contacto contigo!</strong></p>
      <!-- End Heading -->
    </div>
    ...
    <div class="col-lg-3 align-self-end ml-auto g-mb-50">
      <div class="media">
        <div class="d-flex align-self-center">
          <span class="u-icon-v2 u-icon-size--sm g-color-white g-bg-primary rounded-circle mr-3">
              <i class="g-font-size-16 icon-envelope"></i>
            </span>
        </div>
        <div class="media-body align-self-center">
          <h3 class="h6 g-color-black g-font-weight-700 text-uppercase mb-0">Correo</h3>
          <p class="mb-0">contacto@geknology.com</p>
        </div>
      </div>
    </div>
  </div>
